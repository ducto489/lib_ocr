...
class OCRDataModule(LightningDataModule):
    ...
    def train_dataloader(self):
        ...
        return DataLoader(self.train_data, batch_size=self.batch_size, num_workers=self.num_workers, collate_fn=self.collator   )

    def val_dataloader(self):
        self.val_data = OCRDataset(self.val_data_path)
        return DataLoader(self.val_data, batch_size=self.batch_size, num_workers=self.num_workers, collate_fn=self.collator)