...
class OCRCollator:
    ...
    def __call__(self, batch):
        ...
        padded_imgs = torch.zeros((len(images), channels, height, max_width), dtype=torch.float32)
        ...
        padded_labels = torch.zeros((len(encoded_labels), encoded_labels[0].size(0)), dtype=torch.int64)
